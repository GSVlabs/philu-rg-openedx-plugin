...
upgrade-requirements: piptools ## update the requirements/*.txt files with the latest packages satisfying requirements/*.in
...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd oex_plugin && ../manage.py makemessages -l en -v1 -d django
	cd oex_plugin && ../manage.py makemessages -l en -v1 -d djangojs

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd oex_plugin && ../manage.py compilemessages

detect_changed_source_translations:
	cd oex_plugin && i18n_tool changed
