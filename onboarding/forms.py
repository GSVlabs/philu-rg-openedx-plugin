...
#     UserExtendedProfile
# )
# from .helpers import save_user_partner_network_consent
...
#         ('o', gettext_noop("I'd rather not say")),
#         ('nl', gettext_noop('Not listed')),
#     )

#     NO_SELECT_CHOICE = [('', gettext_noop('- Select -'))]
...
#         label_suffix="*",
#         validators=[
#             MinValueValidator(1900, message=gettext_noop('Ensure year of birth is greater than or equal to 1900')),
#             MaxValueValidator(
#                 datetime.now().year, message=gettext_noop('Ensure year of birth is less than or equal to {}'.format(
#                     datetime.now().year
#                 ))
#             )
#         ],
#         error_messages={
#             'required': EMPTY_FIELD_ERROR.format(gettext_noop("Year of birth")),
#         }
#     )
#     gender = forms.ChoiceField(label=gettext_noop('Gender'), required=False, label_suffix="*", choices=GENDER_CHOICES,
#                                widget=forms.RadioSelect)

#     language = forms.CharField(label=gettext_noop('Native Language'), label_suffix="*", required=True,
#                                error_messages={"required": gettext_noop(EMPTY_FIELD_ERROR.format('Language'))},
...
#         widget=forms.HiddenInput,
#         error_messages={
#             "required": gettext_noop(EMPTY_FIELD_ERROR.format("Country of Residence"))
#         }
#     )

#     city = forms.CharField(label=gettext_noop('City of Residence'), required=False, widget=forms.HiddenInput)
#     is_emp_location_different = forms.BooleanField(label=gettext_noop('Check here if your country and/or city of '
#                                                                        'employment is different from your country '
#                                                                        'and/or city of residence.'),
#                                                    required=False)
#     level_of_education = forms.ChoiceField(
#         label=gettext_noop('Level of Education'),
#         label_suffix='*',
#         error_messages={
#             'required': gettext_noop(NO_OPTION_SELECT_ERROR.format('Level of Education'))
#         },
#         required=True
#     )
#     english_proficiency = forms.ChoiceField(
#         label=gettext_noop('English Language Proficiency'),
#         label_suffix='*',
#         error_messages={
#             'required': gettext_noop(NO_OPTION_SELECT_ERROR.format('English Language Proficiency'))
#         }
#     )
#     role_in_org = forms.ChoiceField(
#         label=gettext_noop('Role in the Organization'),
#         label_suffix='*',
#         error_messages={
#             'required': gettext_noop(NO_OPTION_SELECT_ERROR.format('Role in the Organization'))
#         }
#     )
...
#         label_suffix="*",
#         help_text=gettext_noop("You can choose an organization from the auto-suggestion list or add a new one by "
#                                 "entering the name and clicking the OK button."),
#         required=False,
#         widget=forms.TextInput(
#             attrs={'placeholder': gettext_noop('Organization Name')}
#         ),
#         initial=gettext_noop('Organization Name')
#     )

#     is_currently_employed = forms.BooleanField(
#         initial=False,
#         required=False,
#         label=gettext_noop('Check here if you are currently unemployed or otherwise not affiliated with an '
#                             'organization.')
#     )

#     is_poc = forms.ChoiceField(label=gettext_noop('Will you be the Administrator of your organization on our '
#                                                    'website?'),
#                                help_text=gettext_noop("Your organization's Administrator is responsible for "
...
#             'required': gettext_noop('Please select your Organization.'),
#         }
...
#         raise forms.ValidationError(gettext_noop('Please select country of residence.'))
...
#         raise forms.ValidationError(gettext_noop('Please select language.'))
...
#             raise forms.ValidationError(gettext_noop('Please enter Organization Name.'))
...
#                 raise forms.ValidationError(gettext_noop(NO_OPTION_SELECT_ERROR.format(
...
#                 raise forms.ValidationError(gettext_noop("Please enter a valid start month/year"))
...
#                     gettext_noop(EMPTY_FIELD_ERROR.format('Hours per week')))
...
#         if already_an_admin:
#             raise forms.ValidationError(gettext_noop('%s is already admin of organization "%s"'
...
#             raise forms.ValidationError(gettext_noop('%s is already suggested as admin of "%s" organization'
#                                                       % (org_admin_email,
...
#         labels = {
#             'is_emp_location_different': gettext_noop(
#                 'Check here if your country and/or city of employment is different'
#                 ' from your country and/or city of residence.'),
#             'start_month_year': gettext_noop('Start Month and Year*'),
#             'country_of_employment': gettext_noop('Country of Employment'),
#             'city_of_employment': gettext_noop('City of Employment'),
#             'role_in_org': gettext_noop('Role in Organization*'),
#             'function_areas': gettext_lazy('Department or Function (Check all that apply.)')
#         }
#         widgets = {
#             'year_of_birth': forms.TextInput,
#             'not_listed_gender': forms.TextInput(attrs={'placeholder': gettext_noop('Identify your gender here')}),
...
#         error_messages = {
#             "hours_per_week": {
#                 'required': EMPTY_FIELD_ERROR.format(gettext_noop('Typical Number of Hours Worked per Week'))
#             },
#             'start_month_year': {
#                 'required': EMPTY_FIELD_ERROR.format(gettext_noop('Start Month and Year')),
#             }
#         }
...
#             ),
#             'hear_about_philanthropyu': gettext_lazy(
...
#         label=gettext_noop('Does your organization have a website?'),
#         choices=((1, gettext_noop('Yes')), (0, gettext_noop('No'))),
#         label_suffix='*',
#         widget=forms.RadioSelect,
#         initial=1,
...
#         ),
#         error_messages={
#             'required': gettext_noop('Please select an option for "Does your organization have a webpage?"')
#         }
#     )

#     org_type = forms.ChoiceField(
#         label=gettext_noop('Organization Type'),
#         label_suffix='*',
#         error_messages={
#             'required': gettext_noop(NO_OPTION_SELECT_ERROR.format('Organization Type'))
#         }
#     )

#     level_of_operation = forms.ChoiceField(
#         label=gettext_noop('Level of Operation'),
#         label_suffix='*',
#         error_messages={
#             'required': gettext_noop(NO_OPTION_SELECT_ERROR.format('Level of Operation'))
#         }
#     )

#     focus_area = forms.ChoiceField(
#         label=gettext_noop('Primary Focus Area'),
#         label_suffix='*',
#         error_messages={
#             'required': gettext_noop(NO_OPTION_SELECT_ERROR.format('Primary Focus Areas'))
#         }
#     )

#     total_employees = forms.ChoiceField(
#         label=gettext_noop('Total Employees'),
#         label_suffix='*',
...
#         error_messages={
#             'required': gettext_noop(NO_OPTION_SELECT_ERROR.format('Total Employees'))
#         }
#     )
...
#         required=False,
#         error_messages={
#             'required': gettext_noop(NO_OPTION_SELECT_ERROR.format("Partner's"))
#         }
#     )
...
#         labels = {
#             'country': gettext_noop('Country of Organization Headquarters*'),
#             'city': gettext_noop('City of Organization Headquarters'),
#             'founding_year': gettext_noop('Founding Year*'),
#             'is_org_url_exist': gettext_noop('Does your organization have a webpage?'),
#             'url': gettext_noop('Website Address*'),
#             'alternate_admin_email': gettext_noop('Please provide the email address for an alternative Administrator '
...
#         error_messages = {
#             'founding_year': {
#                 'required': gettext_noop(EMPTY_FIELD_ERROR.format('Founding Year')),
#             },
#             'country': {
#                 'required': gettext_noop(EMPTY_FIELD_ERROR.format('Country of Organization Headquarters')),
#             }
#         }

#         help_texts = {
#             "founding_year": gettext_noop("Founding year is the year that your organization was started. This may be "
...
#         raise forms.ValidationError(gettext_noop('Please select country of Organization Headquarters.'))
...
#             raise forms.ValidationError(EMPTY_FIELD_ERROR.format(gettext_noop('Organization Website')))
...
#                 self.add_error(
#                     'founding_year',
#                     gettext_noop('You entered an invalid year format. Please enter a valid year with 4 digits.')
#                 )
...
#         label_suffix="*",
#         widget=forms.TextInput(
#             attrs={'placeholder': gettext_noop('First Name')}
#         )
#     )
...
#         label_suffix="*",
#         widget=forms.TextInput(
#             attrs={'placeholder': gettext_noop('Last Name')}
#         )
#     )
...
#     opt_in = forms.BooleanField(label=gettext_noop('Check here if you agree to receive emails from Philanthropy '
...
#             'required': gettext_noop('Please enter your First Name.'),
#         }

#         self.fields['last_name'].error_messages = {
#             'required': gettext_noop('Please enter your Last Name.'),
#         }

#         self.fields['confirm_password'].error_messages = {
#             'required': gettext_noop('Please enter your Confirm Password.'),
#         }
...
#     """
#     OPT_IN_CHOICES = (
#         ('yes', gettext_noop('Yes, send me special offers')),
#         ('no', gettext_noop("No, don't send me special offers"))
#     )

#     opt_in = forms.ChoiceField(label=gettext_noop('Do you want to hear from us about <strong>*unique funding '
...
#         (True, gettext_noop('Send all reminder emails (recommended)')),
#         (False, gettext_noop('Don\'t send any reminder emails'))
#     )
...
#         label=gettext_noop('Select course'),
...
#         label=gettext_noop('Are you able to provide information requested below?'),
#         choices=((1, gettext_noop('Yes')), (0, gettext_noop('No'))),
#         label_suffix='*',
#         widget=forms.RadioSelect,
#         initial=1,
#         error_messages={
#             'required': gettext_noop('Please select an option for Are you able to provide information')
#         }
#     )
#     effective_date = forms.DateField(input_formats=['%m/%d/%Y'],
#                                      required=False,
#                                      label=gettext_noop('End Date of Last Fiscal Year'),
#                                      help_text=gettext_noop("The fiscal year is the period that an organization uses "
...
#         max_length=30,
#         required=False,
#         label=gettext_noop("Organization's Registration or Tax Identification Number"),
#         help_text=gettext_noop(
...
#         labels = {
#             'actual_data': gettext_noop('Is the information you will provide on this page estimated or actual?*'),
#             'total_clients': gettext_noop('Total Annual Clients or Direct Beneficiaries for Last Fiscal Year'),
#             'total_employees': gettext_noop('Total Employees at the End of Last Fiscal Year'),
#             'local_currency': gettext_noop('Local Currency Code*'),
#             'total_revenue': gettext_noop('Total Annual Revenue for Last Fiscal Year (Local Currency)'),
#             'total_donations': gettext_noop('Total Donations and Grants Received Last Fiscal Year (Local Currency)'),
#             'total_expenses': gettext_noop('Total Annual Expenses for Last Fiscal Year (Local Currency)'),
#             'total_program_expenses': gettext_noop('Total Annual Program Expenses for Last Fiscal Year '
#                                                     '(Local Currency)'),
#         }

#         help_texts = {
#             "actual_data": gettext_noop("If you don't have access to information from official documents, please give "
...
#                                          "information."),
#             "total_clients": gettext_noop("A client or direct beneficiary is any person benefiting directly from your "
...
#             "total_employees": gettext_noop("An employee is a member of your staff who is paid for their work. A staff"
...
#             "total_revenue": gettext_noop("Revenue is the total amount of money your organization receives, regardless"
...
#                                            "income."),
#             "total_donations": gettext_noop("Donations and grants are two different sources of revenue. A donation is"
...
#             "total_expenses": gettext_noop("An expense is money your organization spends in order to deliver its "
...
#             "total_program_expenses": gettext_noop("A program expense is money your organization spends exclusively "
...
#             raise forms.ValidationError(gettext_noop("Please select an option for Estimated or Actual Information"))
...
#             raise forms.ValidationError(gettext_noop(EMPTY_FIELD_ERROR.format("End date for Last Fiscal Year")))

#         if last_fiscal_year_end_date and last_fiscal_year_end_date > datetime.now().date():
#             raise forms.ValidationError(gettext_noop("Please enter a valid End date for Last Fiscal Year"))
...
#             raise forms.ValidationError(gettext_noop(EMPTY_FIELD_ERROR.format("Total Client")))
...
#             raise forms.ValidationError(gettext_noop(EMPTY_FIELD_ERROR.format("Total Employees")))
...
#             raise forms.ValidationError(gettext_noop('Please select Currency Code.'))
...
#             raise forms.ValidationError(gettext_noop(EMPTY_FIELD_ERROR.format("Total Revenue")))
...
#             raise forms.ValidationError(gettext_noop(EMPTY_FIELD_ERROR.format("Total Donations")))
...
#             raise forms.ValidationError(gettext_noop(EMPTY_FIELD_ERROR.format("Total Expenses")))
...
#             raise forms.ValidationError(gettext_noop(EMPTY_FIELD_ERROR.format("Total Program Expense")))
