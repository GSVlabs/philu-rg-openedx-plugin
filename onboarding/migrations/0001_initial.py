    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(related_name='suggested_admins', to='onboarding.Organization', on_delete=models.DO_NOTHING)),
                ('suggested_by', models.ForeignKey(to=settings.AUTH_USER_MODEL,  on_delete=models.DO_NOTHING)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('org', models.ForeignKey(related_name='organization_metrics', to='onboarding.Organization', on_delete=models.DO_NOTHING)),
                ('user', models.ForeignKey(related_name='organization_metrics', to=settings.AUTH_USER_MODEL, on_delete=models.DO_NOTHING)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(related_name='organization_partners', to='onboarding.Organization', on_delete=models.DO_NOTHING)),
            ],
        ),
        migrations.CreateModel(
            name='OrgSector',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(related_name='extended_profile', to=settings.AUTH_USER_MODEL, on_delete=models.DO_NOTHING)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='partner',
            field=models.ForeignKey(related_name='organization_partners', to='onboarding.PartnerNetwork', on_delete=models.DO_NOTHING),
        ),
        migrations.AddField(
