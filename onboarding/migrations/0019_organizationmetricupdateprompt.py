    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('org', models.ForeignKey(related_name='organization_metrics_update_prompts', to='onboarding.Organization', on_delete=models.DO_NOTHING)),
                ('responsible_user', models.ForeignKey(related_name='organization_metrics_update_prompts', to=settings.AUTH_USER_MODEL, on_delete=models.DO_NOTHING)),
            ],
        ),
    ]
