    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization_partner', models.ForeignKey(related_name='grantee_opt_in', to='onboarding.OrganizationPartner', on_delete=models.DO_NOTHING)),
                ('user', models.ForeignKey(related_name='grantee_opt_in', to=settings.AUTH_USER_MODEL, on_delete=models.DO_NOTHING)),
            ],
        ),
        migrations.AddField(
