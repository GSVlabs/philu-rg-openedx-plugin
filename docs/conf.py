...
"""
rg-openedx-plugin documentation build configuration file.
...
project = 'rg-openedx-plugin'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'rg-openedx-plugin'
...
#
# html_title = 'rg-openedx-plugin v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'RG Extentions for Open edX Platform',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'oex_plugin'),
                os.path.join(root_path, 'oex_plugin/migrations')])
